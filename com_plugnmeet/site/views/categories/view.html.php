...
class PlugnmeetViewCategories extends HtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_plugnmeet/assets/css/categories.css', (PlugnmeetHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$this->help_url = PlugnmeetHelper::getHelpUrl('categories');
