	...
	public function postflight($type, ComponentAdapter $parent)
	{
		...
		if ($type === 'update')
		{
			echo '<a target="_blank" href="https://www.plugnmeet.org" title="plugNmeet">
				...
				<h3>Upgrade to Version 1.2.0 Was Successful! Let us know if anything is not working as expected.</h3>';
		}
		return true;
	}
