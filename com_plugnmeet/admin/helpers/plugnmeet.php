...
/**
 * Plugnmeet component helper.
 */
abstract class PlugnmeetHelper
{
	/**
	 * Composer Switch
	 * 
...
/***[JCBGUI.joomla_component.php_helper_both.26.$$$$]***/
    /**
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_plugnmeet/plugnmeet.xml";
	...
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_PLUGNMEET_SUBMENU_DASHBOARD'), 'index.php?option=com_plugnmeet&view=plugnmeet', $submenu === 'plugnmeet');
		if ($user->authorise('room.access', 'com_plugnmeet') && $user->authorise('room.submenu', 'com_plugnmeet'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_PLUGNMEET_SUBMENU_ROOMS'), 'index.php?option=com_plugnmeet&view=rooms', $submenu === 'rooms');
			JHtmlSidebar::addEntry(JText::_('COM_PLUGNMEET_ROOM_ROOMS_CATEGORIES'), 'index.php?option=com_categories&view=categories&extension=com_plugnmeet', $submenu === 'categories');
		}
		if ($user->authorise('recordings.submenu', 'com_plugnmeet'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_PLUGNMEET_SUBMENU_RECORDINGS'), 'index.php?option=com_plugnmeet&view=recordings', $submenu === 'recordings');
		}
	}
	...
	*/
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'plugnmeet')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'plugnmeet', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__plugnmeet_'.$type.' AS a');
	 ...
	 * 
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'plugnmeet', $user = 'null')
	{
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Plugnmeet', $config = array())
	{
		// fix the name
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_plugnmeet');
		
		$parentId = $parent->id;
		$name     = 'com_plugnmeet.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_plugnmeet', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__plugnmeet_'.$table, $object, 'id');
			}
		}
		return false;
	}
	...
	public static function transliterate($string)
	{
		...
		{
			// get global value
			self::$langTag = JComponentHelper::getParams('com_plugnmeet')->get('language', 'en-GB');
		}
