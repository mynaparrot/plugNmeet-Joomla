...
class PlugnmeetTableRoom extends JTable
{
	...
	{
		parent::__construct('#__plugnmeet_room', 'id', $db);
	}	
	...
	/**
	 * Overload the store method for the Room table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New room. A room created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_PLUGNMEET_ROOM_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_plugnmeet.room.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_plugnmeet.room.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = NULL, $id = NULL) 
	{
		...
		$asset->loadByName('com_plugnmeet');
